...
public class SplashActivity extends AppCompatActivity {
    ...
    private FusedLocationProviderClient fusedLocationProviderClient; //기기의 현재 위치 가져오기
    ...
    // onCreate()다음으로 실행되는 함수
    @Override
    protected void onStart() {
        super.onStart();
        checkLocationPermission();
    }
    //위치권한이 혀용되어 있는지 체크하는 함수
    ...
    //원하는 위치 요청을 수행하기 위해 장치에서 관련 시스템 설정이 활성화되어 있는지 확인
